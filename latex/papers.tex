...
% \begin{landscape}
    ...
    \begin{longtable}{
      ...
      >{\centering\arraybackslash}m{1.5cm} % sources
        ...
        The {FORTRAN} automatic coding system~\cite{Backus57}                                                                     & -                   & WJCC                              & C                  & 1957          & -                \\
        An algorithm for translating Boolean expressions~\cite{Arden62}                                                 & ACM                 & JACM                  & J             & 1962          & S                \\
        A programming language~\cite{Iverson62}                                                                              & ACM                 & AFIPS (SJCC)           & C             & 1962          & -                \\
    ...
    Code selection through object code optimization~\cite{Davidson84c}                                                              & ACM                 & TOPLAS                & J             & 1984          & -                \\
        ...
        A mathematics of arrays~\cite{Mullin88}                                                                               & Syracuse            & PhD Thesis            & W             & 1988          & -                \\
        ...
        % An Efficient Semi-Hierarchical Array Layout~\cite{Drakenberg01}                                                          & Springer            & ICCA                  & C             & 2001          & -                \\
